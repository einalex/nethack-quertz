...
(below) are ``safe.'' (Use {\it z} instead of {\it y} if
{\it qwertz\_layout} is set.)
%.sd
\begin{center}
\begin{tabular}{cc}
...
This option can be used to swap the y and z keys for movement and zapping.
This is useful for some keyboard layouts.
%.Ip
\item[\ib{race}]
